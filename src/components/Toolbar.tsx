...
export function Toolbar({
  ...
  return (
    <aside className="flex h-full w-[72px] shrink-0 flex-col items-center gap-1 border-r border-border bg-card py-3">
      <div className="font-mono-stat mb-1 text-[9px] uppercase tracking-wider text-muted-foreground">
        Tools
      </div>
      {TOOLS.map((t) => {
        const Icon = t.icon;
